function Get-MachineInfo {
     ...
     PROCESS {
        foreach ($computer in $computername) {
            ...
            Try {
                ...
                $obj.psobject.TypeNames.Insert(0,"myMachineInfo")

                #add a property set
                $obj | Add-Member -MemberType PropertySet -Name OS -Value 'Computername','OSVersion','OSBuild','Arch' -Force
                Write-Output $obj
            } Catch {
    ...
    Update-TypeData -TypeName $myType -MemberType AliasProperty -MemberName Free -Value SysDriveFreeSpace -force
